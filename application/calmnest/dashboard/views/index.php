...
<section class="article-list">
    <div class="container">
        <div class="intro">
            <h2 class="text-center">Post and View Announcement</h2>
            <h3>
        ...
        <form method="POST" autocomplete="off" required>
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Announcement</span>
            ...
            <div class="mb-3">
                <label for="basic-url" class="form-label">Announcement</label>
                ...
                <div class="form-text" id="basic-addon4">Paste the Announcement's link above.</div>
            </div>
            <div class="input-group">
            ...
            <div class="row articles">
                ...
                <div class="col-sm-6 col-md-4 item"><a href="<?= @$value->Link ?>">
                    ...
                    <a class="action" href="<?= @$value->url ?>"><i class="bi bi-arrow-right-square-fill"></i></a>
                    <button type="button" class="btn btn-primary"> <a href="<?= @$value->Link ?>" target="_blank" rel="noopener noreferrer" class="text-light" target="_blank" rel="noopener noreferrer"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16"> <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0zM4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H4.5z"/></svg></a></button>
