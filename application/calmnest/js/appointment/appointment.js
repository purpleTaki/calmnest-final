$(document).on("click", "#setAppointment", function () {
  ...
  $.post({
    url: base_url + "mobile/Mobile_service/set_appointment",
...
$(document).on("click", ".btnApprove", function () {
  ...
  handleAppointmentAction(
    appointmentID,
    1,
    "mobile/Mobile_service/approve_appointment"
  );
});
...
$(document).on("click", ".btnUndo", function () {
  ...
  handleAppointmentAction(
    appointmentID,
    0,
    "mobile/Mobile_service/set_appointment_pending"
  );
});
// Click event handler for undo button
...
$(document).on("click", ".btnCancel", function () {
  ...
  handleAppointmentAction(
    appointmentID,
    2,
    "mobile/Mobile_service/set_appointment_cancel"
  );
});
// Click event handler for cancel button
