...
$(document).on("click", "#btn-filter", function () {
  // alert();
  $.post({
    url: base_url +  "user/User_service/filter_dpt",
    data: {
      dpt: $('#filterdpt').val(),
      qm: $('#qm').val(),
      yr: $('#yr').val(),
...
$("#save").click(function () {
  $.post({
    url: base_url + "user/User_service/save",
    data: {
      fname: $("#fname").val(),
      mname: $("#mname").val(),
      lname: $("#lname").val(),
...
$(document).on("click", ".edit-btn", function () {
  ...
  $("#edit-user").click(function () {
    $.post({
      url: base_url +  "user/User_service/update",
      data: {
        ID: $("#update").val(),
        fname: $("#fname").val(),
        mname: $("#mname").val(),
...
$("#make-appointment").click(function () {
  ...
  $.post({
    url: base_url +  "user/User_service/make_appointment",
    data: {
      ID: $("#std_ID").val(),
      adate: $("#aDate").val(),
      fromTime: fromTime,
...
$(document).on("click", ".btn-reset", function () {
  var ID = $(this).data("id");
  $.post({
    url: base_url +  "user/User_service/reset",
    data: {
      ID: ID,
    },
    success: function (e) {
