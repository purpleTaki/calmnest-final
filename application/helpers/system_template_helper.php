...
?>
  ...
  <body class="hold-transition layout-top-nav">
    <div class="wrapper">
      <nav class="main-header navbar navbar-expand-md navbar-dark navbar-green" style="background-color: #3058bf;">
        <div class="container">
          <a href="#" class="navbar-brand">
            <img src="<?= base_url() ?>assets/images/logogo.png" height="65" alt="calmnest logo">
          </a>
